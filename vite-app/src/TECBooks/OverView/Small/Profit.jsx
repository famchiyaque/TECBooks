    ...
    <>
      <div className='top-box-content'>
        <div className='top-box-metric'>
          ...
          <Typography variant="h4"  style={{ display: 'inline' }}>{totalProfit}</Typography>
        </div>
        <div className='top-box-subtitle'>
          <Typography style={{ display: 'inline' }} variant="subtitle1">Lifetime Profit</Typography>
